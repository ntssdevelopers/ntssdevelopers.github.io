...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row" style="margin-top: -20px;">
            <div class="col-xs-12">
                <h3 style="color: #007acc;">Hotel Profile</h3>
                <hr style="color: #e6e6e6; border: solid 1px #e6e6e6;">
            </div>            
        </div>            

        <div class="row" style="text-align: left;margin-left: 100px;">
            <div class="col-lg-3">
                <p><label for="">Supplier ID:</label></p>
                <p><label for="">Hotel Name:</label></p>
                <p><label for="">Star Rate:</label></p>
                <p><label for="">P.O. Box:</label></p>
                <p><label for="">Postal Code:</label></p>
                <p><label for="">Area:</label></p>
                <p><label for="">City/Town:</label></p>
                <p><label for="">Country:</label></p>
                <p><label for="">Contact No:</label></p>
                <p><label for="">Email:</label></p>
                <p><label for="">Fax:</label></p>
                <p><label for="">Registration Date:</label></p>                
            </div>
        ...
        <div class="row" style="text-align: left;margin-left: 100px;">
            <div class="col-lg-9">
                <p><label for="">FOS113</label></p>
                <p><label for="">Hotel Name</label></p>
                <p><label for="">3</label></p>
                <p><label for="">202</label></p>
                <p><label for="">611</label></p>
                <p><label for="">Firq</label></p>
                <p><label for="">Nizwa</label></p>
                <p><label for="">Oman</label></p>
                <p><label for="">12345678</label></p>
                <p><label for="">Hotelman@gmail.com</label></p>
                <p><label for="">12345678</label></p>
                <p><label for="">2017-02-24 12:10:10</label></p>                
            </div>
        </div>
    </div>
