...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="submenu-1" class="collapse">
                        ...
                        <li><a href="#" class="active"><i class="fa fa-angle-double-right"></i> Password Manager</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        <div class="row" style="margin-top: -20px;">
            <div class="col-xs-12">
                <h3 style="color: #007acc;">Password Manager</h3>
                <hr style="color: #e6e6e6; border: solid 1px #e6e6e6;">
            </div>            
        </div>            

        <div class="row">
            <div class="col-lg-2" style="text-align: right;margin-top: 6px;">
                <p><label for="">Old Password:</label></p>
            </div>

            <div class="col-lg-4" style="text-align: center;margin-right: 10px;">
                <p>                                      
                    <input class="form-control" type="Password"><!--<p class="help-block">Example block-level help text here.</p>-->
        ...
        <div class="row">
            <div class="col-lg-2" style="text-align: right;margin-top: 6px;">
                <p><label for="">New Password:</label></p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1" style="text-align: center;margin-right: 10px;">
                <p><button type="button" class="btn btn-success" style="width: 102px;"> Save </button></p>
            </div>
