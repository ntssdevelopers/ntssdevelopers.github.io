...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row" style="margin-top: -20px;">
            <div class="col-xs-12">
                <h3 style="color: #007acc;">Logo Manager</h3>
        ...
        <div class="row">
            <div class="col-lg-2" style="text-align: right;margin-top: 6px;">
                <p><label for="">Logo manager:</label></p>
            </div>

            <div class="col-lg-1" style="text-align: center;margin-right: 10px;">
                <p><button type="button" class="btn btn-default"> Choose File </button></p>
            </div>
                
            <div class="col-lg-8" style="text-align: left;margin-top: 6px;color: #3385ff">
                <p style="margin-left: 2px;"><label for="">No File Chosen</label></p>
            </div>                            
        ...
        <div class="row">
            ...
            <div class="col-lg-1" style="text-align: center;margin-right: 10px;">
                <p><img src="cinqueterre.jpg" class="img-rounded" alt="Cinque Terre" width="102" height="110"></p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1" style="text-align: center;margin-right: 10px;">
                <p><button type="button" class="btn btn-success" style="width: 102px;"> Update </button></p>
            </div>
        ...
        <div class="row" style="margin-top: -20px;margin-top: 210px;">
            <div class="col-xs-12">
                <hr style="color: #e6e6e6; border: solid 1px #e6e6e6;">
