...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="submenu-2" class="collapse">
                        ...
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Room Manager</a></li>
    ...
    <div id="page-wrapper">
        <div class="row" style="margin-top: -20px;">
            <div class="col-xs-12">
                <h3 style="color: #007acc;">Room Manager </h3>
         ...
         <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th>Room Size(m) <i class="fa fa-fw fa-sort"></i></th>
                <th>Room Internet <i class="fa fa-fw fa-sort"></i></th>
                <th>Adults <i class="fa fa-fw fa-sort"></i></th>
                <th>Children <i class="fa fa-fw fa-sort"></i></th>
                <th>Check In <i class="fa fa-fw fa-sort"></i></th>
                <th>Check Out <i class="fa fa-fw fa-sort"></i></th>
